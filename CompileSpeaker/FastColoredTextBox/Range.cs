...
namespace FastColoredTextBoxNS
{
    ...
    public class Range : IEnumerable<Place>
    {
        ...
        {
            //search code for style
            StyleIndex layer = tb.GetOrSetStyleLayerIndex(style).ToStyleIndex();
    ...
    {
        /// <summary>
        /// Set style for all ranges of collection
        /// </summary>
        /// <param name="ranges"></param>
        /// <param name="style"></param>
        public static void SetStyle(this IEnumerable<Range> ranges, Style style)
        {
